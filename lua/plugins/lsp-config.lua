...
return {
  { -- LSP configuration & plugins.
    ...
    config = function()
      ...
      -- LSP clients with broken formatting.
      local bad_lsps = {
        'cssls',
        'html',
        -- TSServer usually works poorly. Sorry you work with bad languages.
        -- You can remove this line if you know what you are doing. (: 😼 :)
        'tsserver',
      }
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(args)
          ...
          -- Do not attach to clients with broken formatting.
          for _, bad_lsp in pairs(bad_lsps) do
            if client.name == bad_lsp then
              return
            end
          end

          -- Create an autocmd that will run *before* we save the buffer.
          -- Run the formatting command for the LSP tha has just attached.
